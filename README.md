...
本仓库收录了大傻春的生物竞赛完整笔记，涵盖生物化学、细胞生物学、动物生理学、遗传学、进化生物学、生态行为、生物信息学等核心模块，以及高等数学、Linux 命令行等扩展内容。笔记质量介于神与屎之间，既有大量屎总结，也包含对你的喜爱❤️。
...
*本站基于 神秘东方文字（HTML CSS JS）搭建，由大胖鱼协助开发。*
